    ...
    <div class="luan">
      <div class="df">
        <div class="x">
          ...
          <div>
            <div class="zt">Total number of classes</div>
        ...
        <div class="x">
          ...
          <div>
            <div class="zt">Total number of questions</div>
        ...
        <div class="x">
          ...
          <div>
            <div class="zt">Total number of exam</div>
...
export default {
  ...
  methods: {
    ...
    getPie() {
      ...
      // Specifying chart configuration and data
      var option = {
        // Title
        title: {
        ...
        // Tooltip for displaying data when hovering over the pie chart
        tooltip: {
          trigger: 'item',
        ...
        // Legend
        legend: {
          bottom: 10, // Distance of the legend from the bottom
          left: 'center', // Legend position
          textStyle: {
            color: '#000',
            fontSize: 16
          },
          data: this.chartDataTitle // Legend data
        },
        ...
        series: [{
          ...
          center: ['50%', '50%'], // Position of the pie chart
          data: this.chartData, // Pie chart data
          itemStyle: {
            normal: {
              label: {
                show: true // Whether to display label text on the pie chart
              },
              labelLine: {
                show: true // Whether to display the label line
              }
            }
          }
        }]
      }
      // Displaying the chart with the specified configuration and data
    ...
    getPies() {
      ...
      var option = {
        ...
        legend: {
          ...
          data: this.chartDataTitle2 // Legend data
        },
        // Colors for the pie chart
        color: [
          'rgb(253, 133, 133)',
        ...
        series: [{
          ...
          radius: '60%', // Size of the pie chart
          center: ['50%', '50%'], // Position of the pie chart
          data: this.chartData2, // Pie chart data
          itemStyle: {
            normal: {
              label: {
                show: true // Whether to display label text on the pie chart
